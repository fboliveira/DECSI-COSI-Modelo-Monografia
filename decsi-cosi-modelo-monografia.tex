...
% 20190312 - a posição deste foi alterada conforme orientações do COSI/Biblioteca. Ele deve vir ao final da monografia e não no início, como anteriormente.

% Isto é um exemplo de termo de responsabilidade, um documento obrigatório conforme a Resolução do COSI.
% Você pode utilizar este modelo até a aprovação do trabalho.
% Após isso, substitua todo o conteúdo deste arquivo por uma
% imagem da página assinada por você com o comando abaixo:
%
...
% Isto é um exemplo de declaração de conformidade, um documento obrigatório conforme a Resolução do COSI.
%
% Art. 27 - art. 6: A versão digital da monografia deverá conter, na última página, a Declaração de Conformidade (Anexo IX) devidamente assinada pelo professor orientador.
%
% Você pode utilizar este modelo até a aprovação do trabalho.
% Após isso, substitua todo o conteúdo deste arquivo por uma
% imagem da página assinada pelo(a) seu(sua) orientador(a) com o comando abaixo:
%
% \includepdf{declaracao-de-conformidade.pdf}
%

\imprimirdeclaracaodeconformidade%
